...
hook.Add("TTTSettingsTabs", "SpecDM_TTTSettingsTab", function(dtabs)
	...
	if (LocalPlayer():CheckGroup("prime") or LocalPlayer():IsAdmin()) or LocalPlayer():IsUserGroup("primemoderator") or LocalPlayer():IsUserGroup("primeadmin") or LocalPlayer():IsUserGroup("primeenforcer") or LocalPlayer():IsUserGroup("seniormoderator") then 
