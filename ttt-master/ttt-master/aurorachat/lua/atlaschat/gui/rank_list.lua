...
function panel:Paint(w, h)
	draw.SimpleText(self.text, "atlaschat.ranks.column", self.align_x == TEXT_ALIGN_CENTER and w /2  or self.align_x == TEXT_ALIGN_RIGHT and w -3 or 4, 0, color_column, self.align_x, TEXT_ALIGN_BOTTOM)
end
