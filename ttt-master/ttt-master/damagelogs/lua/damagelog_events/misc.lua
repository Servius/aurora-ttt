...
function event:ToString(v)
	...
	elseif v[1] == 7 then
		return string.format("%s [%s] planted or dropped C4", v[2], Damagelog:StrRole(v[3]))
	end
end
...
function event:IsAllowed(tbl)
	...
	if (tbl[1] == 1 or tbl[1] == 3) and not Damagelog.filter_settings["Show disguises"] then return false end
