...
self.Emitter 		= ParticleEmitter( self.Pos )	// Emitter must be there so you don't get an error			//
			...
			sound.Play( "weapons/wpn_ray_explode.wav", self.Pos, 100, 100 )
			else
			sound.Play( "weapons/wpn_ray_explode.wav", self.Pos)
			sound.Play( "weapons/wpn_ray_explode.wav", self.Pos, 100, 100 )
			end
