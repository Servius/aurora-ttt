...
AccessorFunc( PANEL, "m_aText", "AText" )

surface.CreateFont( "AButtonText", {
	font = "Bebas Neue",
	size = 18,
	weight = 0,
	antialias = true
...
function PANEL:Paint( w, h )
	...
	draw.SimpleText(self.m_aText, "AButtonText", w/2, 2, Color(127, 140, 141) , TEXT_ALIGN_CENTER)
...
local PANEL = derma.DefineControl( "AButton", "A standard Button", PANEL, "DLabel" )
